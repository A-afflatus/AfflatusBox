import { CHATBOT,GITHUBHOTREPO,MOCKSERVER,S3CLIENT,TLDRAW } from '@/routers/constant';
...
import MockServer from '@/apps/mockserver';
...
export default [
    ...
    <Route key={MOCKSERVER} path={MOCKSERVER} element={<MockServer />} />,
]